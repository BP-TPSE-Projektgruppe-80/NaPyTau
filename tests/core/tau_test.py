    ...
    def test_tauCalculation(self):
        ...
        with patch.dict(
            ...
            testing.assert_array_almost_equal(
                calculate_tau_i(doppler_shifted_intensities,
            ...
            self.assertEqual(
                len(chi_mock.optimize_coefficients.mock_calls), 1
            )
            ...
            self.assertEqual(
                len(chi_mock.optimize_t_hyp.mock_calls), 1
            )
            ...
            self.assertEqual(
                chi_mock.optimize_t_hyp.mock_calls[0].args[7],
                1.0
            )


            self.assertEqual(
                len(polynomials_mock.differentiated_polynomial_sum_at_measuring_times
                    .mock_calls), 1
            )
