...
class PolynomialUnitTest(unittest.TestCase):
    def test_raisesAnExceptionIfTheSpecifiedDegreeDoesNotMatchTheNumberOfCoefficients(
        self,
    ):
    ...
    def test_raisesAnExceptionIfTheSpecifiedDegreeDoesNotMatchTheNumberOfCoefficientsWhenUpdatingThePolynomial(
        self,
    ):
