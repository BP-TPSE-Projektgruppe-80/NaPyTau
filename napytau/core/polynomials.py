...
def polynomial_sum_at_measuring_times(times: ndarray, coefficients: ndarray) -> ndarray:
    """
       ...
       Args:
           times (ndarray): Array of time points where the polynomial is evaluated
           coefficients (ndarray): Array of polynomial coefficients [a_0, a_1, ..., a_n],
...
def differentiated_polynomial_sum_at_measuring_times(
    times, coefficients: ndarray
) -> ndarray:
    """
        Computes the sum of the derivative of a polynomial evaluated at given time points.

        Args:
            times (ndarray): Array of time points where the polynomial's derivative is evaluated.
            coefficients (ndarray): Array of polynomial coefficients [a_0, a_1, ..., a_n],
                                  where the polynomial is P(t) = a_0 + a_1*t + a_2*t^2 + ... + a_n*t^n.

        Returns:
            ndarray: Array of the derivative values of the polynomial at the given time points.
        """
    return sum(
